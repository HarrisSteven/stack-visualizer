    ...
    render() {
        return(
            <Grid container className="RunTab">
                <Grid item>
                    {this.props.step ? null : <Button style = {{fontSize: "0.9vw", boxShadow: "0 0 0 0", borderRadius: "0.5vw", minWidth: "4vw", minHeight: "2vw", width: "4vw", height: "2vw"}} variant="contained" color="primary" onClick={this.props.handleRun}>Run</Button>}
                </Grid>
