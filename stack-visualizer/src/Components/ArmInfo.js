    ...
    return (
        <Grid container className = "ArmInfo">
          ...
          <Grid item style={{width: "75vw", marginLeft: "12.5vw", marginBottom: "10vh"}}>
            ...
            <Grid container className="AboutTextBody">
              <Grid item style={{paddingLeft: "1vw", paddingRight: "1vw"}}>
                <h3>The ARM Text Editor accepts ARM code that can be run.  Click generate sample code to randomly generate a sample ARM program.  Running the code will only display the state of the stack and register file after the program finishes.  To view the development of the stack, step through the code using the Step tab, or use the the Visualize tab to step though at a constant rate.  Clicking the Clear button will clear the contents of the stack at any time.</h3>
              </Grid>
            </Grid>
